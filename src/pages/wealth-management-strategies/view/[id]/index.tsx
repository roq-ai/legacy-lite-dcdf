...
import { getWealthManagementStrategyById } from 'apiSdk/wealth-management-strategies';
...
function WealthManagementStrategyViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Wealth Management Strategy Detail View
          </Text>
          {hasAccess('wealth_management_strategy', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/wealth-management-strategies/edit/${data?.id}`} passHref legacyBehavior>
              <Button
...
)(WealthManagementStrategyViewPage);
