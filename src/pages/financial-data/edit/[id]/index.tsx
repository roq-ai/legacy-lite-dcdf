...
import { getFinancialDataById, updateFinancialDataById } from 'apiSdk/financial-data';
...
function FinancialDataEditPage() {
  ...
  const handleSubmit = async (values: FinancialDataInterface, { resetForm }: FormikHelpers<any>) => {
    setFormError(null);
    try {
      const updated = await updateFinancialDataById(id, values);
      mutate(updated);
      resetForm();
