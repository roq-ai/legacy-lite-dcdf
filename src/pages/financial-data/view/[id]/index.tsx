...
import { getFinancialDataById } from 'apiSdk/financial-data';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Financial Data Detail View
          </Text>
          {hasAccess('financial_data', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/financial-data/edit/${data?.id}`} passHref legacyBehavior>
              <Button
