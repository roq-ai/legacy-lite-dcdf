...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['platform-owner', 'backoffice-administrator', 'financial-analyst', 'wealth-manager'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    {
      name: 'Wealth Management Strategy',
      path: '/wealth-management-strategies',
